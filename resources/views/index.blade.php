...
<body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
    ...
    <div class="site-wrap" id="home-section">
      ...
      <div class="ftco-blocks-cover-1">
        <div class="ftco-cover-1 overlay" style="background-image: url('{{asset('assets')}}/ui/images/depot_hero_1.jpg')">
          <div class="container">
          ...
          <div class="container">
            <div class="owl-carousel owl-all">
              ...
              <div class="service text-center">
                <a href="#"><img src="{{asset('assets')}}/ui/images/depot_img_2.jpg" alt="Image" class="img-fluid"></a>
                <div class="px-md-3">
              ...
              <div class="service text-center">
                <a href="#"><img src="{{asset('assets')}}/ui/images/depot_img_3.jpg" alt="Image" class="img-fluid"></a>
                <div class="px-md-3">
      ...
      <div class="site-section bg-light" id="services-section">
        ...
        <form method="post" action="{{ route('frontestimatesofships') }}" autocomplete="off"
          ...
          <div class="row justify-content-center mb-4 block-img-video-1-wrap">
            <div class="col-md-12 mb-5">
              <figure class="block-img-video-1" data-aos="fade">
                ...
                <img src="{{asset('assets')}}/ui/images/depot_delivery_1.jpg" alt="Image" class="img-fluid">
              </a>
              </figure>
            </div>
          </div>
        ...
        <div class="container">
          ...
          <div class="owl-carousel owl-all mb-5">
            <div class="block-team-member-1 text-center rounded h-100">
              <figure>
                <img src="{{asset('assets')}}/ui/images/person_1.jpg" alt="Image" class="img-fluid rounded-circle">
              </figure>
            ...
            <div class="block-team-member-1 text-center rounded h-100">
              <figure>
                <img src="{{asset('assets')}}/ui/images/person_2.jpg" alt="Image" class="img-fluid rounded-circle">
              </figure>
            ...
            <div class="block-team-member-1 text-center rounded h-100">
              <figure>
                <img src="{{asset('assets')}}/ui/images/person_3.jpg" alt="Image" class="img-fluid rounded-circle">
              </figure>
      ...
      <div class="block__73694 site-section border-top" id="why-us-section">
        <div class="container">
          <div class="row d-flex no-gutters align-items-stretch">
            ...
            <div class="col-12 col-lg-6 block__73422 order-lg-2" style="background-image: url('{{asset('assets')}}/ui/images/depot_delivery_1.jpg');" data-aos="fade-left" data-aos-delay="">
            </div>
          ...
          <div class="owl-carousel nonloop-block-13">
            <div>
              <div class="block-testimony-1 text-center">
                ...
                <figure>
                  <img src="{{asset('assets')}}/ui/images/person_1.jpg" alt="Image" class="img-fluid rounded-circle mx-auto">
                </figure>
            ...
            <div>
              <div class="block-testimony-1 text-center">
                ...
                <figure>
                  <img src="{{asset('assets')}}/ui/images/person_2.jpg" alt="Image" class="img-fluid rounded-circle mx-auto">
                </figure>
            ...
            <div>
              <div class="block-testimony-1 text-center">
                ...
                <figure>
                  <img src="{{asset('assets')}}/ui/images/person_3.jpg" alt="Image" class="img-fluid rounded-circle mx-auto">
                </figure>
          ...
          <div class="row">
            <div class="col-lg-6">
              <div class="mb-5 d-block blog-entry" data-aos="fade-right" data-aos-delay="">
                <a href="single.html" class="blog-thumbnail mb-3 d-block"><img src="{{asset('assets')}}/ui/images/depot_img_1.jpg" alt="Image" class="img-fluid"></a>
            ...
            <div class="col-lg-6">
              <div class="mb-5 d-block blog-entry" data-aos="fade-right" data-aos-delay="">
                <a href="single.html" class="blog-thumbnail mb-3 d-block"><img src="{{asset('assets')}}/ui/images/depot_img_2.jpg" alt="Image" class="img-fluid"></a>
                <div class="blog-excerpt">
                  <span class="d-block text-muted">Apr 19, 2019</span>
                  <h2 class="h4  mb-3"><a href="single.html">Knowing the Difference Is Key to Effective Logistics</a></h2>
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
    ...
    <script src="{{asset('assets')}}/ui/js/jquery-3.3.1.min.js"></script>
    <script src="{{asset('assets')}}/ui/js/popper.min.js"></script>
    <script src="{{asset('assets')}}/ui/js/bootstrap.min.js"></script>
    <script src="{{asset('assets')}}/ui/js/owl.carousel.min.js"></script>
    <script src="{{asset('assets')}}/ui/js/jquery.sticky.js"></script>
    <script src="{{asset('assets')}}/ui/js/jquery.waypoints.min.js"></script>
    <script src="{{asset('assets')}}/ui/js/jquery.animateNumber.min.js"></script>
    <script src="{{asset('assets')}}/ui/js/jquery.fancybox.min.js"></script>
    <script src="{{asset('assets')}}/ui/js/jquery.easing.1.3.js"></script>
    <script src="{{asset('assets')}}/ui/js/aos.js"></script>
