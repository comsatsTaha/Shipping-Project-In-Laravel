              ...
              <table class="table">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td class="text-center">
                      <a target="_blank" href="#product/now-ui-dashboard-pro-laravel?ref=nud-free-upgrade-live" class="btn btn-round btn-primary">Upgrade to PRO</a>
                    </td>
                  </tr>
                </tbody>
              </table>
...
<?php echo $__env->make('layouts.app', [
    ...
    'class' => 'sidebar-mini',
    'activePage' => 'upgrade',
  ], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/ahmedpc/Desktop/fyp/shiping/resources/views/pages/upgrade.blade.php ENDPATH**/ ?>