                    ...
                    <div class="form-group">
                        <label style="color:black;"><?php echo e(__("Shipping Company")); ?></label>
                            ...
                            <select name="ship_id" class="form-control"  required> 
                              ...
                              <?php $__currentLoopData = $ships; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                              <option value="<?php echo e($item->id); ?>"> <?php echo e($item->name); ?></option>
                              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.app', [
    ...
    'activePage' => 'pakages',
    'activeNav' => '',
], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel\shiping\resources\views/client/pakages.blade.php ENDPATH**/ ?>