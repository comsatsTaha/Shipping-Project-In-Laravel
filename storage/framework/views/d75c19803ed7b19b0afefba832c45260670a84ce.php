            ...
            <div class="card-body ">
              <form method="POST" action="<?php echo e(route('register')); ?>">
                ...
                <div class="input-group">
                  ...
                  <input class="form-control" placeholder="<?php echo e(__('Phone No')); ?>" type="tel" name="phone_no" value="<?php echo e(old('phone_no')); ?>" required>
                 </div>
...
], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/ahmedpc/Desktop/fyp/shiping/resources/views/auth/register.blade.php ENDPATH**/ ?>