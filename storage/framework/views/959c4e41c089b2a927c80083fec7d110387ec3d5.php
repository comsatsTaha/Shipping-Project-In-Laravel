                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 pr-1">
                                <div class="form-group">
                                    ...
                                    <input type="text" min="0" name="cost" class="form-control" placeholder="Shipping Cost"
                                        value="<?php echo e($package_details->total_value); ?>" disabled>
...
<div class="card-footer ">
    <a href="/cancelled/<?php echo e($package_details->id); ?>" class="btn btn-primary btn-round"><?php echo e(__('Cancel Order')); ?></a>
</div> 
<?php endif; ?>
                        ...
                        <form method="POST" action="<?php echo e(route('order.cost')); ?>" style="<?php if(!empty($package_details->total_value)): ?> display:none <?php endif; ?>">
                            <?php echo csrf_field(); ?>
                            ...
                            <div class="col-md-6 pr-1">
                                <div class="form-group">
                                    ...
                                    <input type="text" min="0" name="cost" class="form-control" placeholder="Shipping Cost"
                                        value="<?php echo e($package_details->total_value); ?>" <?php if(!empty($package_details->total_value)): ?> disabled <?php endif; ?>>
                        ...
                        <form method="POST" action="<?php echo e(route('order.status')); ?>">
                            ...
                            <div class="col-md-6 pr-1">
                                <div class="form-group">
                                    ...
                                    <select name="status_id" class="form-control" required <?php if($package_details->status == 10 || $package_details->status == 8): ?> disabled <?php endif; ?>>
...
<div>
    <input class="star star-5" id="star-5" type="radio" name="star" value="5" <?php echo e($package_details->rating_star==5?'checked':''); ?> disabled/>
    <label class="star star-5" for="star-5"></label>
    <input class="star star-4" id="star-4" type="radio" name="star" value="4" <?php echo e($package_details->rating_star==4?'checked':''); ?>  disabled/>
    <label class="star star-4" for="star-4"></label>
    <input class="star star-3" id="star-3" type="radio" name="star" value="3" <?php echo e($package_details->rating_star==3?'checked':''); ?>  disabled/>
    <label class="star star-3" for="star-3"></label>
    <input class="star star-2" id="star-2" type="radio" name="star" value="2" <?php echo e($package_details->rating_star==2?'checked':''); ?>  disabled/>
    <label class="star star-2" for="star-2"></label>
    <input class="star star-1" id="star-1" type="radio" name="star" value="1" <?php echo e($package_details->rating_star==1?'checked':''); ?>  disabled/>
    <label class="star star-1" for="star-1"></label>
      </div>
      <textarea name="remarks" class="form-control" cols="5" placeholder="Remarks"
      disabled><?php echo e($package_details->rating_review); ?></textarea>
    </div>
</div>
<?php endif; ?>
...
'activePage' => 'pakages',
'activeNav' => '',
], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/ahmedpc/Desktop/fyp/shiping/resources/views/client/packagesdetails.blade.php ENDPATH**/ ?>