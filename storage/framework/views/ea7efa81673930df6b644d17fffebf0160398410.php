            ...
            <nav class="navbar navbar-expand-lg navbar-transparent  bg-primary  navbar-absolute">
                <div class="container-fluid">
                    <div class="navbar-wrapper">
                        ...
                        <a class="navbar-brand" href="#pablo"><?php if (\Illuminate\Support\Facades\Blade::check('admin')): ?> User List <?php endif; ?> <?php if (\Illuminate\Support\Facades\Blade::check('client')): ?> Active Shipper List <?php endif; ?></a>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <h4 class="card-title"><?php if (\Illuminate\Support\Facades\Blade::check('admin')): ?> User List <?php endif; ?> <?php if (\Illuminate\Support\Facades\Blade::check('client')): ?> Active Shipper List <?php endif; ?></h4>
...
<?php /**PATH C:\xampp\htdocs\laravel\shiping\resources\views/users/index.blade.php ENDPATH**/ ?>